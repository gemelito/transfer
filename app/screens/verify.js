...
export default class Verify extends React.Component {
  ...
  render() {
    const { num_economic, model, fuel, kms, quanty, isCamera } = this.state;
      ...
      <KeyboardAvoidingView style={[common.flex_1, common.bg_white]} behavior="padding" enabled>
        ...
        <View>
          ...
          <View style={[common.bg_light, common.mr_10, common.pl_10, common.pt_10, common.pb_10, common.ml_10, common.mr_10, { height: 150 }]}>
            <View style={[common.center, common.absolute, common.pt_10, common.pb_10,
            { bottom: '32%', left: '42%', paddingLeft: 12, paddingRight: 12, borderRadius: 50, borderWidth: 3, borderColor: "white", backgroundColor: 'background: rgba(0,0,0,0.5);' }]}
            >
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => {
              ...
              >
                <Ionicons name="md-camera" size={40} style={[common.text_white,]} />
              </TouchableOpacity>
            </View>
          </View>
          {/* camera */}
